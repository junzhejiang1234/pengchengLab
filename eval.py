...
def main(revenue, initial_revenue, eval_stock, window_size, model_name, debug):
    ...
    if model_name is not None:
        ...
        profit, _ = evaluate_model(revenue, initial_revenue, agent, data, window_size, debug)
...
if __name__ == "__main__":
    ...
    revenue = []
    try:
        main(revenue, initial_revenue, eval_stock, window_size, model_name, debug)
